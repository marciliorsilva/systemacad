	  ...
	  <div class="col-sm-9 col-md-10 affix-content">
	    	<div class="container">
			    ...
			    <div class="page-header">
	              <h3><span class="glyphicon glyphicon-book"></span> &nbsp;Disciplina</h3>
                </div>	
                <div class="row">
               		<form>
            ...
            <div class="table-responsive" style="overflow-y:auto;height:250px; width:100%;">
              <table id="tabela-disciplina" class="table table-hover table-condensed ">
                ...
                <tbody id="tbBodyDisciplina">
                   
                   
                </tbody>
              </table>
            </div>
            <form action="../../paginas/secretaria/disciplina-form.php" method="post" name="enviar_parametros" >
     ...
     <script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script>
      ...
      <script type='text/javascript'>
        ...
        function atualizarTabela(){
          document.getElementById('tbBodyDisciplina').innerHTML = " ";
          document.getElementById('tbBodyDisciplina').innerHTML = "<?php $objControl->listaDisciplinas();?>";
        }
        ...
        $(window).load(function(){
          ...
          $("#btnExcluir").on("click", function (e) {
            ...
            if(cod==null){
              ...
              alert("Selecione uma disciplina para a excluir.");
                 ...
                 $.post('../../paginas/secretaria/processar.php', {
                  ...
                  entidade:'disciplina'
                   ...
                   if(resposta == 1){
                     ...
                     document.getElementById('tbBodyDisciplina').removeChild(document.getElementById(cod));
     ...
     <script>
		    ...
		    $(document).ready(function(){
  		   ...
  		   $("#txtPesquisa").on("keyup", function() {
    			...
    			$("#tbBodyDisciplina tr").filter(function() {
