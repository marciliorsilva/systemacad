...
$objControl = new ProfessorControl();
    ...
    <div class="row affix-row" id="menu-secretaria">
	  ...
	  <div class="col-sm-9 col-md-10 affix-content">
            ...
            <div class="table-responsive" style="overflow-y:auto;height:250px; width:100%;">
              <table id="tabela-professor" class="table table-hover table-condensed ">
                <thead>
                   <tr>
            ...
            <form action="../../paginas/secretaria/professor-form.php" method="post" name="enviar_parametros" >
     ...
     <script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script>
      ...
      <script type='text/javascript'>
        ...
        function atualizarTabela(){
          ...
          document.getElementById('tbBodyProfessor').innerHTML = "<?php $objControl->listaProfessores();?>";
        ...
        $(window).load(function(){
          ...
          $("#tabela-professor > tbody > tr").on("click", function (e) {
                 ...
                 $.post('../../paginas/secretaria/processar.php', {
                  ...
                  entidade:'professor'
                   ...
                   if(resposta == 1){
                     ...
                     document.getElementById('tbBodyProfessor').removeChild(document.getElementById(cod));
     ...
     $(document).ready(function(){
        ...
        $("#txtPesquisa").on("keyup", function() {
          var letra = $(this).val().toLowerCase();
            ...
            $("#tbBodyProfessor tr").filter(function() {
