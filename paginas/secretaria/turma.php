<?php
  ...
  $objControl = new TurmaControl();
  //$objControl->listaTurmas();
    ...
    <div class="row affix-row" id="menu-secretaria">
	  ...
	  <div class="col-sm-9 col-md-10 affix-content">
            ...
            <div class="table-responsive" style="overflow-y:auto;height:250px; width:100%;">
              <table id="tabela-turma" class="table table-condensed table-hover">
                <thead>
                   <tr>
                     <th>Codigo</th>
                     <th>Disciplina</th>
                ...
                <tbody id="tbBodyTurma">
                   
               
                </tbody>
              </table>
            </div>
            <form action="../../paginas/secretaria/turma-form.php" method="post" name="enviar_parametros" >
               <input type="hidden" id="cod" name="cod" value="" />
               <input type="hidden" id="metodo" name="metodo" value="" />
               
            </form>
            <div id="group-button">
              <button  id="btnIncluir" class="btn btn-default">Incluir</button>
              <button id="btnConsultar" class="btn btn-default">Consultar</button>
              <button id="btnExcluir" class="btn btn-default">Excluir</button>
				    </div>
     ...
     <script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script>
      ...
      <script type='text/javascript'>
        ...
        function atualizarTabela(){
          document.getElementById('tbBodyTurma').innerHTML = " ";
          document.getElementById('tbBodyTurma').innerHTML = "<?php $objControl->listaTurmas(); ?>";
        }
        ...
        $(window).load(function(){
          ...
          $("#tabela-turma > tbody > tr").on("click", function (e) {
            $(this).siblings().removeClass("table-active");
            $(this).toggleClass("table-active");
            cod = $(this).attr( 'id' );
          });
          
          //funcao para encaminha o turma selecionado para a consulta
          
          $("#btnConsultar").on("click", function (e) {
            
            if(cod==null){

              alert("Selecione um turma para a consulta.");
           ...
           //funcao encaminhamento para inclusao de um novo turma
          ...
          //funcao encaminhamento para exclusao do turma selecionado
          $("#btnExcluir").on("click", function (e) {
            
            if(cod==null){

              alert("Selecione um turma para a excluir.");
                 ...
                 $.post('../../paginas/secretaria/processar.php', {
                  ...
                  entidade:'turma'
                   ...
                   if(resposta == 1){
                     ...
                     alert('Turma excluido com sucesso.');
                     document.getElementById('tbBodyTurma').removeChild(document.getElementById(cod));
                      
                      
                    
                   }else {
                     alert('Erro ao excluir o turma.');
                   }
     ...
     $(document).ready(function(){
        ...
        $("#txtPesquisa").on("keyup", function() {
          var letra = $(this).val().toLowerCase();
            ...
            $("#tbBodyTurma tr").filter(function() {
