...
<html>
    ...
    <div class="row affix-row" id="menu-secretaria">
	  ...
	  <div class="col-sm-9 col-md-10 affix-content">
            ...
            <div class="table-responsive" style="overflow-y:auto;height:250px; width:100%;">
              <div class="panel-group" id="accordion">
                 ...
                 <div class="panel-body">
                      <table id="tabela-professorDisc" class="table table-hover table-condensed ">
                        <thead>
                           <tr>
                             <th>Professor</th>
                             <th>Disciplinas</th>
            ...
            <form action="../../paginas/secretaria/professorDisciplina-form.php" method="post" name="enviar_parametros" >
     ...
     <script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script>
      ...
      <script type='text/javascript'>
        ...
        function atualizarTabela(){
          ...
          document.getElementById('tbBodyProfessorDisc').innerHTML = "<?php $objControl->listaProfessorDisciplinas(); ?>";
        ...
        $(window).load(function(){
          ...
          $("#tabela-professorDisc > tbody > tr").on("click", function (e) {
            $(this).siblings().removeClass("table-active");
            $(this).toggleClass("table-active");
            cod = $(this).attr( 'id' );
          });
          
          //funcao para encaminha o professor selecionado para a consulta
          
          $("#btnConsultar").on("click", function (e) {
            
            if(cod==null){

              alert("Selecione um professor para a consulta.");
           ...
           //funcao encaminhamento para inclusao de um novo professor
          ...
          //funcao encaminhamento para exclusao do professor selecionado
          $("#btnExcluir").on("click", function (e) {
            
            if(cod==null){

              alert("Selecione um professor para a excluir.");
                 ...
                 $.post('../../paginas/secretaria/processar.php', {
                  ...
                  entidade:'professorDisciplina'
                   ...
                   if(resposta == 1){
                     ...
                     document.getElementById('tbBodyProfessorDisc').removeChild(document.getElementById(cod));
     ...
     $(document).ready(function(){
        ...
        $("#txtPesquisa").on("keyup", function() {
          var letra = $(this).val().toLowerCase();
            ...
            $("#tbBodyProfessorDisc tr").filter(function() {
