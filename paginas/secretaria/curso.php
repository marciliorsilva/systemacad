    ...
    <div class="row affix-row" id="menu-secretaria">
	  ...
	  <div class="col-sm-9 col-md-10 affix-content">
            ...
            <div class="table-responsive" style="overflow-y:auto;height:250px; width:100%;">
              <table id="tabela-curso" class="table table-hover table-condensed " >
                <thead class="">
                   <tr>
                     <th>Codigo</th>
                     <th>Nome</th>
                  ...
                  <tbody id="tbBodyCurso" >
                   
                  </tbody>
               
              </table>
            </div>
            <form action="../../paginas/secretaria/curso-form.php" method="post" name="enviar_parametros" >
     ...
     <script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script>
       ...
       <script type='text/javascript'>
        ...
        function atualizarTabela(){
          document.getElementById('tbBodyCurso').innerHTML = " ";
          document.getElementById('tbBodyCurso').innerHTML = "<?php $objControl->listaCursos();?>";
        }
        ...
        $(window).load(function(){
          ...
          $("#tabela-curso > tbody > tr").on("click", function (e) {
          ...
          $("#btnConsultar").on("click", function (e) {
            ...
            if(cod==null){
              ...
              alert("Selecione um curso para a consulta.");
          ...
          $("#btnExcluir").on("click", function (e) {
            ...
            if(cod==null){
              ...
              alert("Selecione um curso para a excluir.");
                 ...
                 $.post('../../paginas/secretaria/processar.php', {
                  ...
                  entidade:'curso'
                   ...
                   if(resposta == 1){
                     ...
                     document.getElementById('tbBodyCurso').removeChild(document.getElementById(cod));
		 ...
		 $(document).ready(function(){
  			...
  			$("#txtPesquisa").on("keyup", function() {
    			var letra = $(this).val().toLowerCase();
    				...
    				$("#tbBodyCurso tr").filter(function() {
