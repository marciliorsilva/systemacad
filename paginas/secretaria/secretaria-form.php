...
if($metodo=='consultar'){
  ...
  $objModel = $objControlFuncionario->selectFuncionario($codigoFuncionario);
    ...
    <div class="row affix-row" id="menu-secretaria">
	  ...
	  <div class="col-sm-9 col-md-10 affix-content">
	    	<div class="container">
                ...
                <div id="group-button">
                  <a href="../../paginas/secretaria/secretaria.php"><button class="btn btn-default"><span class="glyphicon glyphicon-share-alt"></span></span>&nbsp;Voltar</button></a>
                </div>
	              <h3><span class="glyphicon glyphicon-user"></span> &nbsp;Secretaria</h3>
                
            </div>
            <div class="row">
               <form id="form-funcionario" action="#">
     ...
     <script type="text/javascript">
      ...
      var codigoFuncionario = "<?php echo $codigoFuncionario;?>"; // variavel responsavel por armazenar codigoFuncionario selecionado da tabela passado pelo metodo POSt
      ...
      $(document).ready(function () { 
       ...
       $("#form-funcionario").submit(function() {
         ...
         if(camposNotNull > 0){
            ...
            if($("#txtNome").val()== null || $("#txtNome").val() ==""){
              ...
              $("#txtNome").attr("placeholder","Digite o nome do Funcionario");  
              ...
              $("#txtNome").removeAttr("placeholder","Digite o nome do Funcionario");
            }
            //--------------------------------------
             ...
             $.post('../../paginas/secretaria/processar.php', {
                ...
                entidade:"funcionario"
                    ...
                    if(resposta == 1){
                       ...
                       window.location.href='../../paginas/secretaria/secretaria.php';
