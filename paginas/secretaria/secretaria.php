...
$objControl = new FuncionarioControl();
    ...
    <div class="row affix-row" id="menu-secretaria">
	  ...
	  <div class="col-sm-9 col-md-10 affix-content">
	    	<div class="container">
	              ...
	              <h3><span class="glyphicon glyphicon-user"></span> &nbsp;Secretaria</h3>
            </div>
             <div class="row">
               <form>
            ...
            <div class="table-responsive" style="overflow-y:auto;height:250px; width:100%;">
              <table id="tabela-funcionario" class="table table-hover table-condensed ">
                <thead>
                   <tr>
                ...
                <tbody id="tbBodyFuncionario">
                                      
               
                </tbody>
              </table>
            </div>
            <form action="../../paginas/secretaria/secretaria-form.php" method="post" name="enviar_parametros" >
     ...
     <script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script>
      ...
      <script type='text/javascript'>
        ...
        function atualizarTabela(){
          ...
          document.getElementById('tbBodyFuncionario').innerHTML = "<?php $objControl->listaFuncionarios();?>";
        ...
        $(window).load(function(){
          ...
          $("#tabela-funcionario > tbody > tr").on("click", function (e) {
            $(this).siblings().removeClass("table-active");
            $(this).toggleClass("table-active");
            cod = $(this).attr( 'id' );
          });
          
          //funcao para encaminha o funcionario selecionado para a consulta
          
          $("#btnConsultar").on("click", function (e) {
            
            if(cod==null){

              alert("Selecione um funcionario para a consulta.");
           ...
           //funcao encaminhamento para inclusao de um novo funcionario
          ...
          //funcao encaminhamento para exclusao do funcionario selecionado
          $("#btnExcluir").on("click", function (e) {
            
            if(cod==null){

              alert("Selecione um funcionario para a excluir.");
                              
            }else{


               if(!confirm("Tem certeza que deseja apagar este funcionario?")){
                  return false;
               }else{
                 ...
                 $.post('../../paginas/secretaria/processar.php', {
                  ...
                  entidade:'funcionario'
                   ...
                   if(resposta == 1){
                     ...
                     document.getElementById('tbBodyFuncionario').removeChild(document.getElementById(cod));
     ...
     $(document).ready(function(){
        ...
        $("#txtPesquisa").on("keyup", function() {
          var letra = $(this).val().toLowerCase();
            ...
            $("#tbBodyFuncionario tr").filter(function() {
